...
insert  into `jenis_pembayaran`(`id`,`akun_jenis_pembayaran_id`,`nama_jenis_pembayaran`,`deskripsi_jenis_pembayaran`) values 
(1,1,'Cash','Pembayaran langsung ke kasir'),
(2,1,'Kartu Debit','Pembayaran dengan kartu debit semua bank');
...
insert  into `pengeluaran_harian`(`id`,`akun_id`,`pengeluaran_id`,`rincian_pengeluaran`,`tgl_transaksi`,`harga_satuan`,`jumlah`,`total_pengeluaran`,`catatan`,`bukti_transaksi`) values 
(1,1,13,'Belanja','2022-03-22',15000.00,2,30000.00,'',NULL),
(2,5,14,'Beli makan','2022-04-12',20000.00,1,20000.00,NULL,'');
...
(3,1,'Paragliding','Test',125000.00,'2022-02-11 21:13:54','2022-02-11 21:13:54'),
