    ...
    <div class="col-lg-8">
        ...
        <div class="card my-3">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Pengajuan Pengeluaran</h6>
            </div>
            <div class="card-body mt-2">
                <form action="/pengajuan/insert" method="post" class="mx-3" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                        ...
                        <div class="col-sm-9">
                            <select name="kode_akun_pengeluaran" id="kode_akun_pengeluaran" class="form-control custom-select">
                                ...
                                <?php foreach ($akun as $akun_pengeluaran) : ?>
                                    <option value="<?= $akun_pengeluaran['id']; ?>" <?= ($akun_pengeluaran['id'] == old('kode_akun_pengeluaran') ? 'selected' : ''); ?>><?= $akun_pengeluaran['kode_kategori_akun']; ?>-<?= $akun_pengeluaran['kode_akun']; ?> - <?= $akun_pengeluaran['nama_akun']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="rincian_pengeluaran" name="rincian_pengeluaran" value="<?= old('rincian_pengeluaran'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="tgl_transaksi" class="col-sm-3 col-form-label">Tanggal Transaksi</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tgl_transaksi" name="tgl_transaksi" value="<?= old('tgl_transaksi'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="catatan" class="form-control" id="catatan" cols="3"><?= old('catatan'); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-file">
                                <input type="file" class="form-control custom-file-input" id="bukti_pengeluaran" name="bukti_pengeluaran" onchange="file_pengeluaran()">
