            ...
            <div class="card-body">
                <form action="/pembayaran/insert" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama_jenis_pembayaran" id="nama_jenis_pembayaran" value="<?= old('nama_jenis_pembayaran'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="kode_akun_pembayaran" id="kode_akun_pembayaran" class="form-control custom-select">
                                ...
                                <?php foreach ($akun as $akun_pembayaran) : ?>
                                    <option value="<?= $akun_pembayaran['id']; ?>" <?= ($akun_pembayaran['id'] == old('kode_akun_pembayaran') ? 'selected' : ''); ?>><?= $akun_pembayaran['kode_kategori_akun']; ?>-<?= $akun_pembayaran['kode_akun']; ?> - <?= $akun_pembayaran['nama_akun']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-9">
                            <textarea name="deskripsi_jenis_pembayaran" rows="2" class="form-control" id="deskripsi_jenis_pembayaran" value="<?= old('deskripsi_jenis_pembayaran'); ?>"></textarea>
                        </div>
                    </div>
