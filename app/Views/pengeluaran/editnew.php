            ...
            <div class="card-body mt-2">
                <form action="/pengeluaran/update" method="post" class="mx-3" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="kode_akun_pengeluaran" class="col-sm-3 col-form-label">Kode Akun Pengeluaran</label>
                        <div class="col-sm-9">
                            <select name="kode_akun_pengeluaran" id="kode_akun_pengeluaran" class="form-control custom-select">
                                ...
                                <?php foreach ($akun as $akun_pengeluaran) : ?>
                                    <option value="<?= $akun_pengeluaran['id']; ?>" <?= ($akun_pengeluaran['id'] == $harian['akun_id'] ? 'selected' : ''); ?>><?= $akun_pengeluaran['kode_kategori_akun']; ?>-<?= $akun_pengeluaran['kode_akun']; ?> - <?= $akun_pengeluaran['nama_akun']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="rincian_pengeluaran" name="rincian_pengeluaran" value="<?= $harian['rincian_pengeluaran']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="tgl_transaksi" class="col-sm-3 col-form-label">Tanggal Transaksi</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tgl_transaksi" name="tgl_transaksi" value="<?= $harian['tgl_transaksi']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="harga_satuan" name="harga_satuan" value="<?= $harian['harga_satuan']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="jumlah" name="jumlah" value="<?= $harian['jumlah']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="total" name="total" value="<?= $harian['total_pengeluaran']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="catatan" class="form-control" id="catatan" cols="3"><?= $harian['catatan']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-file">
                                <input type="file" class="form-control custom-file-input" id="bukti_pengeluaran" name="bukti_pengeluaran" onchange="file_pengeluaran()" value="<?= $harian['bukti_transaksi']; ?>">
                                <label for="bukti_pengeluaran" class="custom-file-label">Pilih file ...</label>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="pengeluaran_id" value="<?= $harian['pengeluaran_id']; ?>">
                    <input type="hidden" name="pengeluaran_harian_id" value="<?= $harian['id']; ?>">
