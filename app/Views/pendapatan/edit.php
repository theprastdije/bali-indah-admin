    ...
    <div class="col-lg-8">
        ...
        <div class="card my-3">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Pendapatan</h6>
            </div>
            <div class="card-body mt-2">
                <form action="/pendapatan/update" method="post" class="mx-3">
                    <?= csrf_field(); ?>
                        ...
                        <div class="col-sm-9">
                            <select class="form-control custom-select" name="kode_akun" id="kode_akun">
                                ...
                                <?php foreach ($akun as $acc) : ?>
                                    <option value="<?= $acc['id']; ?>" <?= ($pendapatan['akun_id'] == $acc['id']) ? 'selected' : ''; ?>>(<?= $acc['kode_akun']; ?>) <?= $acc['nama_akun']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control custom-select" name="jenis_pendapatan" id="jenis_pendapatan">
                                ...
                                <option value="o" <?= ($pendapatan['kategori_pendapatan'] == "o") ? 'selected' : ''; ?>>Operasional</option>
                                <option value="i" <?= ($pendapatan['kategori_pendapatan'] == "i") ? 'selected' : ''; ?>>Investasi</option>
                                <option value="p" <?= ($pendapatan['kategori_pendapatan'] == "p") ? 'selected' : ''; ?>>Pendanaan</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tgl_transaksi" name="tgl_transaksi" value="<?= $pendapatan['tgl_transaksi']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="rincian" class="col-sm-3 col-form-label">Rincian</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="rincian" name="rincian" value="<?= $pendapatan['rincian_pendapatan']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="jumlah" name="jumlah" value="<?= $pendapatan['jumlah']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
