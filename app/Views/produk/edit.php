                ...
                <form action="/produk/update" method="post">
                        ...
                        <div class="col-sm-9">
                            <select name="kategori_produk" id="kategori_produk" class="form-control custom-select">
                                ...
                                <?php foreach ($kategori as $kategori) : ?>
                                    <option <?= ($produk['kategori_produk_id'] == $kategori['id']) ? 'selected' : ''; ?> value="<?= $kategori['id']; ?>"><?= $kategori['kode_kategori_produk']; ?> - <?= $kategori['nama_kategori_produk']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-9">
                            <textarea name="deskripsi_produk" rows="2" class="form-control" id="deskrpsi_produk"><?= $produk['deskripsi_produk']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-9">
                            ...
                            <input type="number" class="form-control" name="harga_produk" id="harga_produk" value="<?= $produk['harga_produk']; ?>">
                        </div>
                    </div>
