...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <a href="/produk/addcategory" class="btn btn-primary mb-3"><i class="fas fa-fw fa-plus"></i> Tambah Data Baru</a>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($kategori as $kategori) : ?>
                                <tr>
                                    ...
                                    <td><?= $kategori['kategori_akun']; ?>-<?= $kategori['kode_akun']; ?></td>
                                    <td><?= $kategori['kode_kategori_produk']; ?></td>
                                    <td>
                                        <a href="/produk/editcategory/<?= $kategori['id']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-fw fa-edit"></i> Edit</a>
