...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="card my-3">
            ...
            <div class="card-body">
                <form action="/kas/insert" method="post">
                    <?= csrf_field(); ?>
                    <div class="form-group row">
                        <label for="jenis_kas" class="col-sm-3 col-form-label">Jenis Kas</label>
                        <div class="col-sm-9">
                            <select name="jenis_kas" id="jenis_kas" class="form-control custom-select">
                                <option>Pilih Jenis Kas ...</option>
                                <option value="masuk" <?= (old('jenis_kas') == 'masuk') ? 'selected' : ''; ?>>Kas masuk (setor kas)</option>
                                <option value="keluar" <?= (old('jenis_kas') == 'keluar') ? 'selected' : ''; ?>>Kas keluar (tarik kas)</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="kode_akun_kas" id="kode_akun_kas" class="form-control custom-select">
                                ...
                                <?php foreach ($akun as $akun_kas) : ?>
                                    <option value="<?= $akun_kas['id']; ?>" <?= ($akun_kas['id'] == old('kode_akun_kas') ? 'selected' : ''); ?>><?= $akun_kas['kode_kategori_akun']; ?>-<?= $akun_kas['kode_akun']; ?> - <?= $akun_kas['nama_akun']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <select name="jenis_pajak" id="jenis_pajak" class="form-control custom-select">
                                ...
                                <?php foreach ($pajak as $pajak) : ?>
                                    <option value="<?= $pajak['id']; ?>" <?= ($pajak['id'] == old('jenis_pajak') ? 'selected' : ''); ?>><?= $pajak['jenis_pajak']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-9">
                            <textarea name="deskripsi_kas" rows="2" class="form-control" id="deskripsi_kas"><?= old('deskripsi_kas'); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-9">
                            ...
                            <input type="text" class="form-control" name="jumlah_kas" id="jumlah_kas" value="<?= old('jumlah_kas'); ?>">
                        </div>
                    </div>
