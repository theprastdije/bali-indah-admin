...
<form action="/aset/insertcategory" method="post">
    <?= csrf_field(); ?>
    <div class="row">
        <div class="col-lg-6">
            <div class="card my-3">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Kategori Aset</h6>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <label for="nama_kategori_aset" class="col-sm-3 col-form-label">Nama Kategori</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama_kategori_aset" id="nama_kategori_aset">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-9">
                            <select name="jenis_aset" id="jenis_aset" class="form-control custom-select">
                                ...
                                <option value="nb1">Bukan Bangunan - Kelompok 1</option>
                                <option value="nb2">Bukan Bangunan - Kelompok 2</option>
                                <option value="nb3">Bukan Bangunan - Kelompok 3</option>
                                <option value="nb4">Bukan Bangunan - Kelompok 4</option>
                                <option value="bp">Bangunan Permanen</option>
                                <option value="btp">Bangunan Tidak Permanen</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-9">
                            <select name="metode_penyusutan_fiskal" id="metode_penyusutan_fiskal" class="form-control custom-select">
                                ...
                                <option value="gl">Garis Lurus</option>
                                <option value="sm">Saldo Menurun</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="masa_manfaat_fiskal" id="masa_manfaat_fiskal" maxlength="2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="persen_penyusutan_fiskal" id="persen_penyusutan_fiskal" maxlength="5">
                                <div class="input-group-append">
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="masa_manfaat_komersial" id="masa_manfaat_komersial" maxlength="2">
                                <div class="input-group-append">
                                    <span class="input-group-text">tahun</span>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="persen_penyusutan_komersial" id="persen_penyusutan_komersial" maxlength="5">
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
